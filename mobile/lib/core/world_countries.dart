...
/// share the same `dial` — the local number carries the area code.
const kWorldCountries = <({String code, String name, String dial})>[
...
String worldCountryName(String? code) {
