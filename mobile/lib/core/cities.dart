...
const kCities = <CityOption>[
  ...
  CityOption(city: 'Barcelona', cityTh: 'บาร์เซโลนา', countryCode: 'ES', countryName: 'Spain'),
  CityOption(city: 'Zurich', cityTh: 'ซูริก', countryCode: 'CH', countryName: 'Switzerland'),
  CityOption(city: 'Vienna', cityTh: 'เวียนนา', countryCode: 'AT', countryName: 'Austria'),
  CityOption(city: 'Copenhagen', cityTh: 'โคเปนเฮเกน', countryCode: 'DK', countryName: 'Denmark'),
  CityOption(city: 'Oslo', cityTh: 'ออสโล', countryCode: 'NO', countryName: 'Norway'),
  CityOption(city: 'Stockholm', cityTh: 'สตอกโฮล์ม', countryCode: 'SE', countryName: 'Sweden'),
  CityOption(city: 'Amsterdam', cityTh: 'อัมสเตอร์ดัม', countryCode: 'NL', countryName: 'Netherlands'),
  CityOption(city: 'Brussels', cityTh: 'บรัสเซลส์', countryCode: 'BE', countryName: 'Belgium'),
  CityOption(city: 'Kuala Lumpur', cityTh: 'กัวลาลัมเปอร์', countryCode: 'MY', countryName: 'Malaysia'),
  CityOption(city: 'Penang', cityTh: 'ปีนัง', countryCode: 'MY', countryName: 'Malaysia'),
